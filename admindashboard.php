...
// Query to count the number of faculties
...
if ($result) {
    ...
    // Output the result
    echo "<h4>Number of Faculties</h4>";
    echo "<h2>$facultyCount</h2>";
} else {
...
<h2><?php echo $completedProjectsCount; ?></h2>
                ...
                <div class="tab-content mt-2">
                    ...
                    <div class="tab-pane fade show active" id="addOneFaculty" role="tabpanel"
                        ...
                        <form action="AddFaculty.php" method="POST" >
                            ...
                            <div class="mb-3">
                                <label for="facultyContact" class="name-label">Contact No.</label>
                                <input type="text" name="contact" id="contact" class="form-control form-control-lg bg-light fs-6"
                                    placeholder="Faculty Contact No.">
                            </div>
                            <div class="mb-3">
  ...
  <div class="modal fade" id="remove-faculty-modal" tabindex="-1" aria-labelledby="removeFacultyModalLabel"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Your form for assigning a project goes here -->
          <form id="removeStudentForm"  method="POST" action="DeleteFaculty.php" >
            <div class="mb-3">
  ...
  <script src="Addprojectval.js"></script>
  <script >function Addproject() {
