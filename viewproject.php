    ...
    <aside id="sidebar">
      ...
      <div class="h-100">
        ...
        -->
          ...
          <li class="sidebar-item">
            <a href="view_faculties.html" class="sidebar-link">
...
$query = "SELECT p.project_id, p.project_name, GROUP_CONCAT(s.student_id) AS student_ids
          FROM project p
          LEFT JOIN student s ON p.project_id = s.project_id
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['student_ids']; ?></td>
                      </tr>
                      <?php
                  }
                  ?>
