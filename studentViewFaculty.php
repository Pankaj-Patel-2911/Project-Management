...
// Query to fetch data 
$query = "SELECT f.faculty_id, f.faculty_name, f.faculty_email, GROUP_CONCAT(p.project_name SEPARATOR ', ') AS managing_projects
          FROM faculty f
          LEFT JOIN project p ON f.faculty_id = p.faculty_id
          GROUP BY f.faculty_id, f.faculty_name, f.faculty_email";
            ...
            <div class="card-border-0">
                <div class="card-header">
                    <h3 class="class-title" style="margin-left: 40% ; padding: 20px;">
                        List of Faculties and Their Projects
                    </h3>
                </div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Managing Projects</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['managing_projects']; ?></td>
                                </tr>
                                <?php
                            }
                            ?>
